...
Most tools that support custom OpenAI endpoints can work with the gateway.

Common examples:

- [OpenAI SDKs](https://developers.openai.com/api/docs/libraries)
- CLI tools with OpenAI-compatible configuration
- Coding assistants that allow custom base URLs and keys

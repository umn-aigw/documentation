# Change Log
Both the LoonAI Gateway and the LiteLLM project are actively evolving. We'll aim to capture major changes here. If you've got questions, please reach out to the [AI Gateway support team](mailto:aigateway@umn.edu).
